...
const querySchema = z.object({ dataset: z.string().max(32).default('main'), reality: z.string().max(100).optional(), search: z.string().max(120).optional(), limit: z.coerce.number().int().min(1).max(500).default(500) });
